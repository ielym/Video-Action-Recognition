...
def video_pipe(filenames):
    videos, labels = fn.readers.video(device="gpu", file_list=filenames, sequence_length=sequence_length, pad_sequences=True, stride=8, shard_id=0, num_shards=1, random_shuffle=False, initial_fill=initial_prefetch_size)
...
if __name__ == '__main__':
    ...
    for epoch_idx in range(100):
        for batch_idx, data in enumerate(dali_iter):
            ...
            # print("epoch: {}, batch {}, frames size: {}, device : {}".format(epoch_idx, batch_idx, frames.size(), frames.device))
