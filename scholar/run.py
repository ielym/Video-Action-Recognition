...
# CUDA_VISIBLE_DEVICES=2,3 python -m torch.distributed.launch --nproc_per_node=2 run.py
...
# Train
parser.add_argument('--device', default=[0, 1, 2, 3], type=list, help='[] empty for CPU, or a list like [0] or [0, 2, 3] for GPU')
...
# parser.add_argument('--pretrained_weights', default='./last.pth', type=str, help='')
